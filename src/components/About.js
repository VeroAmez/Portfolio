        ...
        <div className="texto-sobre-mi">
          ...
          <div className="bloque">
            ...
            <ul>
              ...
              <li>
                <strong>Licenciatura:</strong> Ingeniería en Sistemas Computacionales en el Tecnlógico de Ciudad Guzmán. Con especialidad en Inteligencia Artificial Aplicada. Materias terminadas en diciembre 2024, graduación en marzo 2025 y titulación en abril 2025.
              </li>
            </ul>
          </div>
